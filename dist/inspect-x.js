...
if (nativeBind) {
  ...
  if (isWorking) {
    ...
    isWorking = bind_x_esm_res.threw === false && gra === 1 && bind_x_esm_context === bind_x_esm_testThis && bind_x_esm_res.value.length === 3;
  }
...
var gpo = get_prototype_of_x_esm_isWorking ? patchedGetPrototypeOf : implementation;
