...
;(function () {
  ...
  formatValueIt = function formatValue(ctx, value, recurseTimes) {
    ...
    if (ES.IsCallable(value)) {
      keys = filterUnwanted(keys, unwantedFunction);
    ...
    if (ctx.showHidden) {
      ...
      if (ES.IsCallable(value)) {
        keys = filterUnwanted(keys, unwantedFunction);
        unshiftUniq(keys, 'prototype');
        unshiftUniq(keys, 'caller');
...
},{"define-properties":2,"es-abstract/es6":7,"has-own-property-x":23,"has-symbol-support-x":24,"is-array-buffer-x":25,"is-data-view-x":28,"is-date-object":31,"is-error-x":32,"is-nil-x":34,"is-object-like-x":37,"is-primitive":38,"is-symbol":39,"is-typed-array":40,"lodash.isnull":42,"to-string-tag-x":43,"validate.io-undefined":44}],2:[function(require,module,exports){
'use strict';
...
},{"./helpers/isFinite":10,"./helpers/mod":12,"./helpers/sign":13,"es-to-primitive/es5":15,"is-callable":21}],7:[function(require,module,exports){
'use strict';
...
},{"./es5":6,"./helpers/assign":9,"./helpers/isFinite":10,"./helpers/isPrimitive":11,"./helpers/mod":12,"./helpers/sign":13,"es-to-primitive/es6":16,"function-bind":20,"is-regex":22}],8:[function(require,module,exports){
'use strict';
...
},{"./helpers/isPrimitive":17,"is-callable":21}],16:[function(require,module,exports){
'use strict';
...
},{"./helpers/isPrimitive":17,"is-callable":21,"is-date-object":18,"is-symbol":19}],17:[function(require,module,exports){
...
},{"es-abstract/es6":7,"has-to-string-tag-x":26,"is-object-like-x":27,"to-string-tag-x":43}],26:[function(require,module,exports){
/**
 * @file
...
},{"has-symbol-support-x":24}],27:[function(require,module,exports){
/**
 * @file
...
},{"es-abstract":14,"is-primitive":38}],28:[function(require,module,exports){
/**
 * @file
...
},{"es-abstract/es6":7,"has-to-string-tag-x":29,"is-object-like-x":30,"to-string-tag-x":43}],29:[function(require,module,exports){
arguments[4][26][0].apply(exports,arguments)
},{"dup":26,"has-symbol-support-x":24}],30:[function(require,module,exports){
arguments[4][27][0].apply(exports,arguments)
},{"dup":27,"es-abstract":14,"is-primitive":38}],31:[function(require,module,exports){
...
},{"is-object-like":33,"to-string-tag-x":43}],33:[function(require,module,exports){
'use strict'
...
},{"lodash.isnull":35,"validate.io-undefined":36}],35:[function(require,module,exports){
/**
...
arguments[4][27][0].apply(exports,arguments)
},{"dup":27,"es-abstract":14,"is-primitive":38}],38:[function(require,module,exports){
/*!
...
},{"foreach":41}],41:[function(require,module,exports){
...
},{"es-abstract/es6":7}],44:[function(require,module,exports){
